...
##############################################
carbon = np.loadtxt((cwd + "/sourceData/carbonTrans.txt"), dtype = float,comments ="#",)
pt = np.loadtxt((cwd + "/sourceData/PtTrans.txt"), dtype = float,comments ="#",)
...
dimaondEn = 10000                   # Energy in eV ?
diamondFlux = 1e13              # Flux in photons/s 
ptThick = 30 * nano_cm          # thickness of Pt coating 
