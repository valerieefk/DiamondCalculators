...
##############################################
carbon = np.loadtxt((cwd + "/Scratch/sourceData/carbon.txt"), dtype = float,comments ="#",)
pt = np.loadtxt((cwd + "/scratch/sourceData/pt.txt"), dtype = float,comments ="#",)
al = np.loadtxt((cwd + "/scratch/sourceData/al.txt"), dtype = float,comments ="#",)
